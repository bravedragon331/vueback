...
var update = __webpack_require__(34)("927f4622", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_src_validations_validations_js__ = __webpack_require__(787);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_src_const_js__ = __webpack_require__(754);
//
//
//
//
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            if (this.formstate.$invalid) {
                ...
                axios.post(__WEBPACK_IMPORTED_MODULE_3_src_const_js__["a" /* default */].host + '/register', this.model).then(function (res) {
                    _this.$router.push("/");
                }).catch(function (err) {
                    console.log(err);
                });
