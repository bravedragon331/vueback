...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-58b462bc", Component.options)
  } else {
    hotAPI.reload("data-v-58b462bc", Component.options)
  }
...
var update = __webpack_require__(34)("4f70bf57", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-58b462bc\",\"scoped\":false,\"hasInlineConfig\":true}!./chartist.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-58b462bc\",\"scoped\":false,\"hasInlineConfig\":true}!./chartist.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(34)("230c9704", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-58b462bc\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1&bustCache!./dashboard.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-58b462bc\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1&bustCache!./dashboard.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_echarts_v3_src_full_js__ = __webpack_require__(227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_v_chartist__ = __webpack_require__(840);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_chartist__ = __webpack_require__(833);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        loadDeptReport: function loadDeptReport() {
            var _this = this;

            __WEBPACK_IMPORTED_MODULE_5_src_store_store__["a" /* default */].commit('changeLoading', true);
            axios.post(__WEBPACK_IMPORTED_MODULE_6_src_const_js__["a" /* default */].host + '/api/dashboard/load_dept_report').then(function (res) {
                console.log(res);
                var getDeptName = function getDeptName(Idx) {
                    for (var i = 0; i < res.data.list.length; i++) {
                        if (res.data.list[i].DeptIdx == Idx) return res.data.list[i].DeptName;
                    }
                };
                var getDeptPlan = function getDeptPlan(Idx) {
                    console.log(res.data.list);
                    var ttt = [];
                    for (var i = 0; i < 12; i++) {
                        var b = true;
                        for (var j = 0; j < res.data.list.length; j++) {
                            if (res.data.list[j].DeptIdx == Idx && res.data.list[j].Month == i) {
                                ttt.push(res.data.list[j].Plan);
                                b = false;
                                break;
                            }
                        }
                ...
                var getDeptActual = function getDeptActual(Idx) {
                    var ttt = [];
                    for (var i = 0; i < 12; i++) {
                        var b = true;
                        for (var j = 0; j < res.data.list.length; j++) {
                            if (res.data.list[j].DeptIdx == Idx && res.data.list[j].Month == i) {
                                ttt.push(res.data.list[j].Actual);
                                b = false;
                                break;
                            }
                        }
                ...
                var deptlist = [];
                for (var i = 0; i < res.data.list.length; i++) {
                    if (deptlist.indexOf(res.data.list[i].DeptIdx) == -1) deptlist.push(res.data.list[i].DeptIdx);
                }
                console.log(deptlist);

                for (var i = 0; i < deptlist.length; i++) {
                    _this.stacked.series.push({
                        name: getDeptName(deptlist[i]) + ' Plan',
                        type: 'bar',
                        stack: getDeptName(deptlist[i]),
                        data: getDeptPlan(deptlist[i])
                    });
                    _this.stacked.series.push({
                        name: getDeptName(deptlist[i]) + ' Actual',
                        type: 'bar',
                        stack: getDeptName(deptlist[i]),
                        data: getDeptActual(deptlist[i])
                    });
                }

                console.log(_this.stacked.series);
                _this.loading = false;
        ...
        loadYearOrderStatus: function loadYearOrderStatus() {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_5_src_store_store__["a" /* default */].commit('changeLoading', true);
            axios.post(__WEBPACK_IMPORTED_MODULE_6_src_const_js__["a" /* default */].host + '/api/dashboard/load_year_order_report').then(function (res) {
                // console.log(res.data.list);
                for (var i = 0; i < res.data.list.length; i++) {
                    _this2.bar.data.labels.push(res.data.list[i].BuyerName);
                    _this2.bar.data.series[0].push(res.data.list[i].Amount);
                    _this2.bar.data.series[1].push(res.data.list[i].Profit);
                }
            }).catch(function (err) {
                if (err.response && err.response.status == 401) {
                    __WEBPACK_IMPORTED_MODULE_5_src_store_store__["a" /* default */].commit('logout');
    ...
    [
      _c(
        "b-card",
        {
          ...
          attrs: { header: "Order Status by Department", "header-tag": "h4" }
        },
        [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-58b462bc", module.exports)
  }
}
